...
GOVERNANCE_FILES.push('scripts/init-acceptance-checkpoint.mjs');
GOVERNANCE_FILES.push('docs/process/mvc-package-layout.yaml','docs/process/mvc-package-layout.md','docs/process/schemas/mvc-type-layout.schema.json','scripts/lib/mvc-package-layout.mjs');
